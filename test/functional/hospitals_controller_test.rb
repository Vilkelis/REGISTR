...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { description: @hospital.description, name: @hospital.name, namefull: @hospital.namefull }
    end
  ...
  test "should update hospital" do
    put :update, id: @hospital, hospital: { description: @hospital.description, name: @hospital.name, namefull: @hospital.namefull }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
